...
describe('[ 07 ] Unit tests for: Comments Model', () => {
    ...
    before(() => __awaiter(void 0, void 0, void 0, function* () {
        sinon.stub(mongoose_1.Model, 'create').resolves(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
        sinon.stub(mongoose_1.Model, 'find').resolves([mock_1.COMMENT_INSTANCE_MOCK_WITH_ID]);
        sinon.stub(mongoose_1.Model, 'findOne').resolves(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
        sinon.stub(mongoose_1.Model, 'findByIdAndUpdate').resolves(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
        sinon.stub(mongoose_1.Model, 'findByIdAndDelete').resolves(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
    }));
    after(() => {
        sinon.restore();
    });
    it('Create is possible with mongoose', () => __awaiter(void 0, void 0, void 0, function* () {
        const request = yield newCommentsModel.create(mock_1.COMMENT_INSTANCE_MOCK);
    ...
    it('Get all is possible with mongoose', () => __awaiter(void 0, void 0, void 0, function* () {
        const request = yield newCommentsModel.read({});
        expect(request).to.be.deep.equal([mock_1.COMMENT_INSTANCE_MOCK_WITH_ID]);
    }));
    it('Get One is possible with mongoose', () => __awaiter(void 0, void 0, void 0, function* () {
        const request = yield newCommentsModel.readOne(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID._id);
        expect(request).to.be.deep.equal(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
    }));
    it('Get One is impossible with mongoose when the id is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield newCommentsModel.readOne(mock_1.WRONG_ID_MOCK);
        }
        catch (error) {
            errorToTest = error;
        }
    ...
    it('Update is possible with mongoose', () => __awaiter(void 0, void 0, void 0, function* () {
        const request = yield newCommentsModel.update(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID._id, mock_1.COMMENT_INSTANCE_MOCK);
        expect(request).to.be.deep.equal(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
    }));
    it('Update is impossible with mongoose when the id is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        let errorToTest = null;
        try {
            yield newCommentsModel.update(mock_1.WRONG_ID_MOCK, mock_1.COMMENT_INSTANCE_MOCK);
        }
        catch (error) {
            errorToTest = error;
        }
    ...
    it('Delete is possible with mongoose', () => __awaiter(void 0, void 0, void 0, function* () {
        const request = yield newCommentsModel.delete(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID._id);
        expect(request).to.be.deep.equal(mock_1.COMMENT_INSTANCE_MOCK_WITH_ID);
    }));
    it('Delete is impossible with mongoose when the id is invalid', () => __awaiter(void 0, void 0, void 0, function* () {
        let errorToTest = null;
        try {
            yield newCommentsModel.delete(mock_1.WRONG_ID_MOCK);
        }
        catch (error) {
            errorToTest = error;
        }
