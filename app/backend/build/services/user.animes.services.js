...
const user_animes_interface_1 = __importDefault(require("./../interfaces/user.animes.interface"));
const ErrorMessages_1 = __importDefault(require("../helpers/ErrorMessages"));
const HttpStatus_1 = __importDefault(require("../helpers/HttpStatus"));
class UserAnimesServices {
    constructor(_model) {
        this._model = _model;
    }
    ;
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const validation = user_animes_interface_1.default.safeParse(payload);
...
exports.default = UserAnimesServices;
